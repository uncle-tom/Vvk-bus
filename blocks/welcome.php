		...
		<div class="row">
			<div class="col-md-12">
				<div class="welcome__heading text-center">
					...
					<h2 class="d-flex justify-content-center align-items-center mb-5"><span class="mr-3">Укажите направление, которое Вас интересует</span> <div class="btn btn-primary">список направлений</div></h2>
					<div class="booking">
