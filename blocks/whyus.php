<div class="whyus py-5">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="d-flex justify-content-center mb-2">
					<h2>Почему VVK-Bus</h2>	
				</div>
			</div>
		</div>
	</div>
				...
				<div class="col-md-3">
					...
					<div class="whyus__item">
						...
						<div class="whyus__item__text">
							...
							<div class="whyus__secondline"><span>более 15 лет</span></div>	
						</div>
					</div>
					<!-- end whyus__item 1 -->
				</div>
				<div class="col-md-3">
					...
					<div class="whyus__item">
						...
						<div class="whyus__item__text">
							...
							<div class="whyus__secondline"><span>и доступно объяснят</span></div>	
						</div>
					</div>
					<!-- end whyus__item 2 -->
				</div>
				<div class="col-md-3">
					...
					<div class="whyus__item">
						...
						<div class="whyus__item__text">
							...
							<div class="whyus__secondline"><span>от 10 лет стажа</span></div>	
						</div>
					</div>
					<!-- end whyus__item 3 -->
				</div>
				<div class="col-md-3">
					...
					<div class="whyus__item">
						...
						<div class="whyus__item__text">
							...
							<div class="whyus__secondline"><span>прямо на сайте</span></div>	
						</div>
					</div>
					<!-- end whyus__item 4 -->
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="buttons">
						...
						<a href="/order"><div class="my-btn btn-white"><span>заказать билет</span></div></a>
